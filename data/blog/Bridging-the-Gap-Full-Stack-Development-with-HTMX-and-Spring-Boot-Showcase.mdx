...
images: https://cdn-images-1.medium.com/max/13824/1*aj8Tc_O_5KiIYxSrGh2H4g.png
---
...
{% gist https://gist.github.com/MaheshBabu11/7a7f271330a20a26d761219c2d22dc9a.js %}
...
{% gist https://gist.github.com/MaheshBabu11/951b57a534f7ca148921b66d46943fc1.js %}
Certainly! Let’s break down the functionality of both APIs defined in the provided Java code:

1.  /api/fonts :
    This API is called to provide a list of font options that can be used in the ASCII art generator. It retrieves a list of font names from the **Font** enum, which is part of the Banana library. Using Java Stream API, it maps each font name to an HTML _<option>_ element and appends them to a _StringBuilder_. The method returns the concatenation of these _<option>_ elements as a single HTML string.

2.  /api/ascii-art :
    This API takes user input text and the selected font as parameters and generates ASCII art accordingly. It uses the BanaUtils.bananaify method is then used to generate ASCII art based on the input text and selected font. The generated ASCII art is wrapped in a _<pre>_ HTML tag.
